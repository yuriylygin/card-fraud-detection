...
Создать датасет
```shell
python src/data/manage.py create --n-customers=150000 --n-terminals=10000 --start-date=2022-01-01 --nb-days=5 --radius=10
```

Дополнить датасет
```shell
python src/data/manage.py update --start-date=2022-02-01 --nb-days=5 --radius=5
```
